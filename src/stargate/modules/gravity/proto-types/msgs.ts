 ...
 */
export interface MsgSetMinFeeTransferToEth {
  sender: string;
  fee: string;
}

export interface MsgSetMinFeeTransferToEthResponse {}
...
function createBaseMsgSetMinFeeTransferToEth(): MsgSetMinFeeTransferToEth {
  return { sender: "", fee: "" };
}

export const MsgSetMinFeeTransferToEth = {
  encode(message: MsgSetMinFeeTransferToEth, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.sender !== "") {
      writer.uint32(10).string(message.sender);
    }
    if (message.fee !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MsgSetMinFeeTransferToEth {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgSetMinFeeTransferToEth();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): MsgSetMinFeeTransferToEth {
    return {
      sender: isSet(object.sender) ? String(object.sender) : "",
  ...
  toJSON(message: MsgSetMinFeeTransferToEth): unknown {
    const obj: any = {};
    message.sender !== undefined && (obj.sender = message.sender);
  ...
  fromPartial<I extends Exact<DeepPartial<MsgSetMinFeeTransferToEth>, I>>(
    object: I,
  ): MsgSetMinFeeTransferToEth {
    const message = createBaseMsgSetMinFeeTransferToEth();
    message.sender = object.sender ?? "";
...
function createBaseMsgSetMinFeeTransferToEthResponse(): MsgSetMinFeeTransferToEthResponse {
  return {};
}

export const MsgSetMinFeeTransferToEthResponse = {
  encode(_: MsgSetMinFeeTransferToEthResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): MsgSetMinFeeTransferToEthResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgSetMinFeeTransferToEthResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromJSON(_: any): MsgSetMinFeeTransferToEthResponse {
    return {};
  },

  toJSON(_: MsgSetMinFeeTransferToEthResponse): unknown {
    const obj: any = {};
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<MsgSetMinFeeTransferToEthResponse>, I>>(
    _: I,
  ): MsgSetMinFeeTransferToEthResponse {
    const message = createBaseMsgSetMinFeeTransferToEthResponse();
    return message;
  },
};
...
export interface Msg {
  ...
  SetMinFeeTransferToEth(request: MsgSetMinFeeTransferToEth): Promise<MsgSetMinFeeTransferToEthResponse>;
...
export class MsgClientImpl implements Msg {
  ...
  constructor(rpc: Rpc) {
    ...
    this.SetMinFeeTransferToEth = this.SetMinFeeTransferToEth.bind(this);
  ...
  SetMinFeeTransferToEth(request: MsgSetMinFeeTransferToEth): Promise<MsgSetMinFeeTransferToEthResponse> {
    const data = MsgSetMinFeeTransferToEth.encode(request).finish();
    const promise = this.rpc.request("gravity.v1.Msg", "SetMinFeeTransferToEth", data);
    return promise.then((data) => MsgSetMinFeeTransferToEthResponse.decode(new _m0.Reader(data)));
  }
